...
#ifndef LITTLEPINK_GITCOMMANDLINE_SWIFT_H
#define LITTLEPINK_GITCOMMANDLINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LittlePink_GitCommandLine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25LittlePink_GitCommandLine11AppDelegate")
...
SWIFT_CLASS("_TtC25LittlePink_GitCommandLine13SceneDelegate")
...
SWIFT_CLASS("_TtC25LittlePink_GitCommandLine14ViewController")
